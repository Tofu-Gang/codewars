...
def tribonacci(signature: List[int | float], n: int) -> List[int]:
    """
    :param signature: sequence to start tribonacci sequence with
    :param n: how many first elements from tribonacci sequence to return
    :return: first n elements from tribonacci sequence
    """
